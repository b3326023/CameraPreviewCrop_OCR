...
public class TouchView extends View {
	...
	private float mLeftTopPosX = 300;
	private float mLeftTopPosY = 370;

	private float mRightTopPosX = 700;
	private float mRightTopPosY = 370;

	private float mLeftBottomPosX = 300;
	private float mLeftBottomPosY = 580;

	private float mRightBottomPosX = 700;
...
//			}
	...
	private void manhattanDistance(float x, float y) {
		...
		else if (rightTopMan < 100){
			mLeftTopBool = false;
			mRightTopBool = true;
			mLeftBottomBool = false;
			mRightBottomBool = false;
		}
		else if (leftBottomMan < 100){
			mLeftTopBool = false;
			mRightTopBool = false;
			mLeftBottomBool = true;
			mRightBottomBool = false;
		}
		else if (rightBottomMan < 100){
			mLeftTopBool = false;
			mRightTopBool = false;
			mLeftBottomBool = false;
